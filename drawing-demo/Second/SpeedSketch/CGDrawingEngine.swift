...
//        }
    ...
    func draw(segment: StrokeSegment, in context: CGContext, toSample: StrokeSample, fromSample: StrokeSample) {
        ...
        context.setStrokeColor(toSample.color)
        context.setLineWidth(toSample.lineWidth)
    ...
    func fillColor(in context: CGContext, toSample: StrokeSample, fromSample: StrokeSample) {
        if !toSample.predicted {
            context.setFillColor(toSample.color)
        }
    }
